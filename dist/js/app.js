(() => {
    ...
    function initSliders() {
        if (document.querySelector(".psych__slider")) new swiper_core_Swiper(".psych__slider", {
        ...
        if (document.querySelector(".psych__slider")) new swiper_core_Swiper(".case__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
